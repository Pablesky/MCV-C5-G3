...
if __name__ == '__main__':
    ...
    cfg.SOLVER.BASE_LR = 0.00009999  # pick a good LR
    ...
    cfg.OUTPUT_DIR = './finetune-segmentation-evaluation'
    cfg.INPUT.MASK_FORMAT = 'bitmask'
    ...
    # LINK: https://github.com/facebookresearch/detectron2/issues/1059
    trainer.resume_or_load(resume=False)

    #Use the created predicted model in the previous step
    st = inference_on_dataset(trainer.model, val_loader, evaluator)
